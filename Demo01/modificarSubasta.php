<?php
	...
	//SI NO SE HIZO NINGUNA OFERTA Y NO LLEGO A LA FECHA VENCIMIENTO SE PUEDE MODIFICAR LA SUBASTA, MUESTRO FORMULARIO PARA REALIZAR MODIFICACION
	...
	$fecha_venc = strtotime($data['fecha_fin']);
	//fecha vencimiento
