...
// verificar si el usuario ya esta registrado
		...
		isset($_POST['pais']) && !empty($_POST['pais']))
	{
		...
		if($cant > 0){
			echo '<script type="text/javascript">', 'alert("Hey parece que hay alguien registrado con este nombre de usuario, por favor, elige otro"); document.location = registrarse.php;', '</script>';
